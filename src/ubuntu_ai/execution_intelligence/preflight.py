...
class PreflightEngine:
    ...
    def check(self, capability: ToolCapability) -> PreflightReport:
        ...
        supported_systems = {item.lower() for item in capability.operating_systems}
        ...
        checks.append(
            PreflightCheck(
                ...
                message=(
                    ...
                    if available
                    else (f"Nenhum executável de {capability.name} foi encontrado no PATH.")
                ),
        ...
        if capability.minimum_version and available:
            ...
            checks.append(
                PreflightCheck(
                    ...
                    message=(
                        f"Versão {version} atende ao mínimo {capability.minimum_version}."
                        if compatible
                        else (
    ...
    def _version_at_least(current: str, minimum: str) -> bool:
        ...
        for current_item, minimum_item in zip_longest(current_parts, minimum_parts, fillvalue=0):
