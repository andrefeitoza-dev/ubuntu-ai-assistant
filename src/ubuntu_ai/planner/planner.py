...
class Planner:
    ...
    def create_plan(
        ...
        with self._measurement("planner"):
            return self._create_plan(normalized_request, context, intent)
    ...
    def _create_plan(
        ...
        logger.info(
            ...
            extra={
                ...
                "intent_goal": intent.goal.value if intent else None,
            },
        )
        ...
        if self._ai_planner is not None:
            ...
            plan = self._ai_planner.create_plan(plan_input, context=context)
