    ...
    def build(self, failure: FailureAnalysis) -> RecoveryPlan:
        ...
        if failure.kind is FailureKind.NETWORK:
            return RecoveryPlan(
                ...
                retry_allowed=True,
                requires_confirmation=False,
                guidance=("Valide conectividade e resolução DNS antes da nova tentativa.",),
            )
        ...
        if failure.kind is FailureKind.INVALID_INPUT:
            return RecoveryPlan(
                ...
                retry_allowed=False,
                requires_confirmation=False,
                guidance=("Corrija os argumentos antes de qualquer nova execução.",),
            )
        ...
        return RecoveryPlan(
            ...
            retry_allowed=False,
            requires_confirmation=True,
            guidance=("A falha não é conhecida; faça revisão manual antes de continuar.",),
        )
